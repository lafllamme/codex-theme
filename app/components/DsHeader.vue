<template>
    ...
    >
        <div class="flex items-center">
            <NuxtLink
                to="/"
                class="flex items-center gap-3.5 pl-3 no-underline group"
            >
                <svg
                ...
                <p
                    class="font-geist-700 text-[15.5px] leading-none text-pureWhite tracking-tight"
                >
                    Theme Lab
                </p>
            </NuxtLink>
        ...
        <div class="hidden items-center gap-1.5 pr-1.5 md:flex">
            <NuxtLink
                to="/"
                class="font-geist-600 rounded-full px-[22px] py-2 text-[14.5px] text-pureWhite no-underline transition-colors hover:bg-pureWhite/5"
            >
                Home
            </NuxtLink>
            <NuxtLink
                to="/docs"
                class="font-geist-500 rounded-full px-[22px] py-2 text-[14.5px] text-pureWhite/65 no-underline transition-colors hover:bg-pureWhite/5 hover:text-pureWhite"
            >
                Docs
            </NuxtLink>
        </div>
