...
const heroHeadline = computed(() => {
    ...
    if (words[0] !== "CODEX") return normalized;
...
<template>
    <div class="pointer-events-none absolute inset-0 select-none">
        ...
        >
            <p
                class="font-geist-mono-500 mb-5 text-[11px] text-pureWhite/60 tracking-[0.22em] uppercase"
            >
                Editorial Theme Engine
            </p>

            <h1
                class="hero-headline-glow font-geist-800 max-w-[12ch] text-pureWhite text-[clamp(3.5rem,8vw,7.7rem)] leading-[0.88] tracking-[-0.03em]"
            >
                <template
            ...
            <p
                class="font-geist-400 mt-5 max-w-[54ch] text-[16px] text-pureWhite/76 leading-[1.45] sm:text-[20px]"
            >
                {{ body }}
            </p>
        ...
        >
            <div
                class="w-full text-center lg:col-start-2 lg:col-span-6 lg:text-left 2xl:col-start-3 2xl:col-span-6"
            >
                ...
                <h1
                    class="hero-headline-glow font-geist-800 w-fit max-w-full text-[clamp(3.25rem,8vw,6rem)] text-pureWhite leading-[0.9] tracking-[-0.04em]"
                >
                    <span
                ...
                <p
                    class="hero-intro hero-delay-4 font-geist-400 mt-2 max-w-xl text-[19px] text-pureWhite/74 leading-[1.6]"
                >
                    {{ body }}
                </p>

                <div
                    class="mt-4 flex flex-wrap items-center justify-center gap-4 lg:justify-start"
                >
                    <NuxtLink
                        to="/themes"
            ...
            <div
                class="relative w-full lg:col-start-8 lg:col-span-4 2xl:col-start-9 2xl:col-span-4"
            >
                <div
                    class="pointer-events-none absolute inset-0 z-0 rounded-full bg-emerald-500/10 blur-[80px] translate-x-10 -translate-y-10"
                />
                <DsGlassSurface
                    ...
                    <div class="relative z-10 flex flex-col gap-8">
                        <div class="group flex items-start gap-6">
                            <Icon
                                ...
                                class="size-7 color-sand-11 transition-colors group-hover:color-pureWhite"
                            />
                            <div class="flex flex-col gap-1">
                                <p
                                    class="m-0 font-geist-600 text-base text-pureWhite tracking-wide"
                                >
                                    Semantic Token Sets
                                </p>
                                <p
                                    class="m-0 font-geist-300 text-sm color-sand-11 leading-relaxed"
                                >
        ...
        >
            <p
                class="font-geist-mono-500 mb-4 text-[11px] text-pureWhite/56 tracking-[0.24em] uppercase"
            >
                Minimal Editorial
            </p>

            <h1
                class="hero-headline-glow font-geist-700 max-w-[10.5ch] text-pureWhite text-[clamp(3.9rem,9.2vw,9.2rem)] leading-[0.86] tracking-[-0.035em]"
            >
                <template
                    v-for="(line, index) in headlineLines"
                    :key="`${line}-${index}`"
            ...
            <p
                class="font-geist-400 mt-6 max-w-[48ch] text-[15px] text-pureWhite/71 leading-[1.5] sm:"
            >
                {{ body }}
            </p>
