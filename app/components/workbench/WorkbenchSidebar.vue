...
function openAutomations() {
  marketplaceStore.openAutomations()
  emit('closeMobile')
}
    ...
    >
      ...
      >
        <div class="grid gap-[6px]">
          ...
          <button class="group relative grid wb-sidebar-nav-row grid-cols-[16px_minmax(0,1fr)] min-h-[36px] w-full items-center gap-[11px] border border-transparent rounded-[12px] bg-transparent px-[10px] text-left transition-colors hover:border-[color:var(--wb-hover-border)] hover:bg-[var(--wb-hover-bg)]" @click="emit('openSearchCommand')">
