...
<template>
  ...
  >
    <div class="relative overflow-hidden">
      ...
      <div
        class="relative z-10 grid grid-cols-1 mt-9 gap-4 lg:grid-cols-3"
      >
        <article
          ...
          <div class="relative z-10">
            ...
            <div class="grid mt-8 gap-3 sm:grid-cols-3">
              <div
                ...
                :key="layer.name"
                class="border rounded-2xl border-solid p-4"
      ...
      <div
        class="relative z-10 grid grid-cols-1 mt-4 gap-4 lg:grid-cols-3"
      >
        <article
          class="h-full flex flex-col justify-between border rounded-[1.7rem] p-5 text-[#171717] bg-pureWhite"
        >
          <div>
            <div class="flex items-start justify-between gap-3">
              <span
            ...
            <span
              class="font-geist-mono-700 mt-4 inline-flex rounded-full px-3 py-2 text-[10px] text-[#202020] leading-none tracking-tight uppercase bg-pureBlack/10"
            >
              PASS AAA
            </span>
          </div>
        ...
        <article
          class="h-full flex flex-col border rounded-[1.7rem] bg-sand-1 p-5 transition-colors duration-200 hover:bg-slate-2"
        >
          <div class="flex items-start justify-between gap-3">
            <span
              class="font-geist-mono-500 text-[10px] color-sand-8 tracking-[0.18em] uppercase"
          ...
          <div class="mt-6 space-y-4">
            <div
              ...
              :key="item.label"
              class="flex items-center justify-between border-b border-solid pb-2.5 border-pureWhite/8"
            >
              <span
        ...
        <article
          class="border-white/7 h-full flex flex-col border rounded-[1.7rem] bg-sand-1 p-5 transition-colors duration-200 hover:bg-slate-2"
        >
          <div class="flex items-start justify-between gap-3">
            <span
              class="font-geist-mono-500 text-[10px] color-sand-8 tracking-[0.18em] uppercase"
            ...
            >
{
  ...
  "field": "codeThemeId"
      ...
      >
        <code
          class="bg-black/70 font-geist-mono-500 absolute right-7 top-7 max-w-[58%] inline-flex truncate rounded-xl px-3 py-1 text-[10px] color-sand-8 leading-none lg:right-10 lg:top-10"
        >
          {{ stepScripts.step06 }}
        </code>
        <div>
        ...
        <NuxtLink
          to="/themes"
          class="font-geist-600 group inline-flex items-center justify-center gap-2 border rounded-full px-4 py-4 text-[14px] text-[#1B1B1B] tracking-tight uppercase transition-transform duration-200 bg-pureWhite lg:min-w-[16rem] active:scale-[0.99] hover:scale-[1.02]"
        >
          Explore Themes
          <Icon
